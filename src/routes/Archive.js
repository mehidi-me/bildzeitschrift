    ...
    <>
      ...
      <div className="archive_page">
        <div className="container">
          <button
            className="btn_primary w-100 filters_toggle_btn"
            onClick={() => {
              setFiltersShow(true);
            }}
          >
            ...
            <div className="filters">
              ...
              >
                    ...
                    <div className="filters_container">
                      <div className="filter">
                        <div className="select">
                          <div className="btn drop_btn">
                            Titel{" "}
                            <span>
                              <span className="notify">02</span>
                              <img src={ArrowIcon} />
                            </span>
                          </div>
                          <div className="options">
                            <div className="input">
                              <input
                                type="text"
                                placeholder="Persönlichkeiten suchen ..."
                              />
                            </div>
                            <div className="items">
                ...
                <div className="actions">
                  <button
                    className="btn_primary bg w-100 an filters_show_btn"
                    style={{ marginBottom: "20px" }}
                  >
                    Auswahl anzeigen
                  </button>
                  <button
                    className="btn_primary w-100 an"
                    style={{
                      background: "#2B2A2A",
                      color: "white",
                      cursor: "pointer",
