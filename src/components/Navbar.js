          ...
          <div className="container">
            ...
            <div className="nav_links">
              <ul
                className={
                  menubarShow
                    ? "links navigations show"
                    : searchFormShow
                    ? "links navigations"
                    : "links navigations margin"
                }
              >
              ...
              <ul className="links">
                <li className="icon" onClick={handleLinkClick}>
                  <a>
                    <form
                      className={
                        searchFormShow ? "search_form show" : "search_form"
                      }
                    >
      ...
      <div className={miniCartShow ? "mini_cart show" : "mini_cart"}>
        ...
        <div className="actions">
          ...
          <Link
            ...
            className="btn_primary bg icon"
          >
            Zur Kasse <img src={require("../assets/icons/arrow.png")} />
          </Link>
        </div>
      </div>
    </>
